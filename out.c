...
// *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*- PROGRAM ENTRY POINT *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-
  ...
  L_simple_env_expansion_16:
	...
	MOV(R3, IMM(0))
	MOV(R4, IMM(1))
L_simple_env_expand_16:
	CMP(R3, 0)
	JUMP_EQ(L_simple_env_expand_end_16)
	MOV(R5, INDD(R2, R3))
	MOV(INDD(R1, R4), R5)
	INCR(R3)
	INCR(R4)
	JUMP(L_simple_env_expand_16)
L_simple_env_expand_end_16:
	PUSH(FPARG(1))
	CALL(MALLOC)
	MOV(R3, R0)
	DROP(1)
	...
	MOV(R5, FPARG(1))
	ADD(R5, IMM(2))
L_simple_param_copy_16:
	CMP(R4, R5)
	JUMP_EQ(L_simple_param_copy_end_16)
	MOV(R9, R4)
	SUB(R9, IMM(2))
	MOV(R6, FPARG(R4))
	MOV(INDD(R3, R9), R6)
	INCR(R4)
	JUMP(L_simple_param_copy_16)
L_simple_param_copy_end_16:
	MOV(INDD(R1, 0), R3)
	PUSH(IMM(3))
	CALL(MALLOC)
	DROP(1)
	MOV(INDD(R0, 0), IMM(T_CLOSURE))
	MOV(INDD(R0, 1), R1)
	MOV(INDD(R0, 2), LABEL(L_lambda_simple_16))
	JUMP(L_lambda_simple_end_16)
L_lambda_simple_16:
	PUSH(FP)
	MOV(FP, SP)
	MOV(R15, FPARG(1))
...
L_lambda_simple_end_16:
  ...
  L_simple_env_expansion_17:
	...
	MOV(R3, IMM(0))
	MOV(R4, IMM(1))
L_simple_env_expand_17:
	CMP(R3, 0)
	JUMP_EQ(L_simple_env_expand_end_17)
	MOV(R5, INDD(R2, R3))
	MOV(INDD(R1, R4), R5)
	INCR(R3)
	INCR(R4)
	JUMP(L_simple_env_expand_17)
L_simple_env_expand_end_17:
	PUSH(FPARG(1))
	CALL(MALLOC)
	MOV(R3, R0)
	DROP(1)
	...
	MOV(R5, FPARG(1))
	ADD(R5, IMM(2))
L_simple_param_copy_17:
	CMP(R4, R5)
	JUMP_EQ(L_simple_param_copy_end_17)
	MOV(R9, R4)
	SUB(R9, IMM(2))
	MOV(R6, FPARG(R4))
	MOV(INDD(R3, R9), R6)
	INCR(R4)
	JUMP(L_simple_param_copy_17)
L_simple_param_copy_end_17:
	MOV(INDD(R1, 0), R3)
	PUSH(IMM(3))
	CALL(MALLOC)
	DROP(1)
	MOV(INDD(R0, 0), IMM(T_CLOSURE))
	MOV(INDD(R0, 1), R1)
	MOV(INDD(R0, 2), LABEL(L_lambda_simple_17))
	JUMP(L_lambda_simple_end_17)
L_lambda_simple_17:
	PUSH(FP)
	MOV(FP, SP)
	MOV(R15, FPARG(1))
...
L_lambda_opt_end_6:
  ...
  L_simple_env_expansion_18:
	...
	MOV(R3, IMM(0))
	MOV(R4, IMM(1))
L_simple_env_expand_18:
	CMP(R3, 0)
	JUMP_EQ(L_simple_env_expand_end_18)
	MOV(R5, INDD(R2, R3))
	MOV(INDD(R1, R4), R5)
	INCR(R3)
	INCR(R4)
	JUMP(L_simple_env_expand_18)
L_simple_env_expand_end_18:
	PUSH(FPARG(1))
	CALL(MALLOC)
	MOV(R3, R0)
	DROP(1)
	...
	MOV(R5, FPARG(1))
	ADD(R5, IMM(2))
L_simple_param_copy_18:
	CMP(R4, R5)
	JUMP_EQ(L_simple_param_copy_end_18)
	MOV(R9, R4)
	SUB(R9, IMM(2))
	MOV(R6, FPARG(R4))
	MOV(INDD(R3, R9), R6)
	INCR(R4)
	JUMP(L_simple_param_copy_18)
L_simple_param_copy_end_18:
	MOV(INDD(R1, 0), R3)
	PUSH(IMM(3))
	CALL(MALLOC)
	DROP(1)
	MOV(INDD(R0, 0), IMM(T_CLOSURE))
	MOV(INDD(R0, 1), R1)
	MOV(INDD(R0, 2), LABEL(L_lambda_simple_18))
	JUMP(L_lambda_simple_end_18)
L_lambda_simple_18:
	PUSH(FP)
	MOV(FP, SP)
	MOV(R15, FPARG(1))
