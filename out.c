...
#define DO_SHOW 1
#define MEM_START 2
#define FREE_VAR_TAB_START (MEM_START + 75)
...
, T_FRACTION, 1, 3
, T_FRACTION, 1, 4
, T_STRING, 2, 'a', 'b', T_SYMBOL, MEM_START + 22
, T_STRING, 1, 'e', T_SYMBOL, MEM_START + 28
, T_STRING, 1, 'q', T_SYMBOL, MEM_START + 33
, T_INTEGER, 1
, T_PAIR, MEM_START + 14, MEM_START + 1
, T_PAIR, MEM_START + 38, MEM_START + 40
, T_PAIR, MEM_START + 38, MEM_START + 1
, T_STRING, 6, 'v', 'e', 'c', 't', 'o', 'r', T_SYMBOL, MEM_START + 49
, T_VECTOR, 1, MEM_START + 57, T_STRING, 4, 'l', 'i', 's', 't', T_SYMBOL, MEM_START + 62
, T_VECTOR, 1, MEM_START + 68, T_INTEGER, 3
};
memcpy(M(mem) + MEM_START, consts, sizeof(long) * 75);
...
long symbols[1 + 10] = {0
 	, MEM_START + 26, SYM_TAB_START + 2
	, MEM_START + 31, SYM_TAB_START + 4
	, MEM_START + 36, SYM_TAB_START + 6
	, MEM_START + 57, SYM_TAB_START + 8
	, MEM_START + 68, T_NIL
};
PUSH(IMM(10))
